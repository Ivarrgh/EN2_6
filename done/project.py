...
main_manager = pygame_gui.UIManager((800, 600), '/Users/jael/Desktop/SCHOOL/cv1014/theme_two.json')
top_movie_manager = pygame_gui.UIManager((800, 600), '/Users/jael/Desktop/SCHOOL/cv1014/theme_one.json')
top_movie_manager_2 = pygame_gui.UIManager((800, 600), '/Users/jael/Desktop/SCHOOL/cv1014/theme_one.json')
movie_genre_manager = pygame_gui.UIManager((800, 600), '/Users/jael/Desktop/SCHOOL/cv1014/theme_one.json')
movie_genre_manager_2 = pygame_gui.UIManager((800, 600), '/Users/jael/Desktop/SCHOOL/cv1014/theme_one.json')
production_manager = pygame_gui.UIManager((800, 600), '/Users/jael/Desktop/SCHOOL/cv1014/theme_one.json')
production_manager_2 = pygame_gui.UIManager((800, 600), '/Users/jael/Desktop/SCHOOL/cv1014/theme_one.json')
release_date_manager = pygame_gui.UIManager((800, 600), '/Users/jael/Desktop/SCHOOL/cv1014/theme_one.json')
release_date_manager_2 = pygame_gui.UIManager((800, 600), '/Users/jael/Desktop/SCHOOL/cv1014/theme_one.json')
edit_manager = pygame_gui.UIManager((800, 600), '/Users/jael/Desktop/SCHOOL/cv1014/theme_one.json')
...
shownMovies['year'] = pd.to_datetime(metadata['release_date'], errors='coerce').apply(lambda x: str(x).split('-')[0] if x != np.nan else np.nan)
...
menu_title = pygame_gui.elements.ui_label.UILabel(text="NOTFLIX",
                                           relative_rect= pygame.Rect((0, 200), (800, 50)),
...
view_num_title = pygame_gui.elements.ui_label.UILabel(text="How many movies do you want to see?",
                                           relative_rect= pygame.Rect((175, 170), (450, 40)),
...
view_yrs = pygame_gui.elements.ui_drop_down_menu.UIDropDownMenu(options_list=["2017", "2016", "2015", "2014", "2013", "2012", "2011", "2010", "2009", "2008", "2007", "2006", "2005", "2004", "2003", "2002", "2001", "2000"],
                                                            ...
                                                            relative_rect=pygame.Rect((280, 300), (240, 50)),
                                                            manager=release_date_manager,
...
edit = pygame_gui.elements.UIButton(relative_rect=pygame.Rect((600, 500), (100, 40)),
                                            text='Edit',
                                            manager=main_manager,
                                            tool_tip_text='Please refer back to SPYDER.')
            ...
            if event.user_type == pygame_gui.UI_BUTTON_PRESSED:
                if event.ui_element == view_top_movie:
                    ...
                    if password == "1": 
                        ...
                        new_movie['title'] = input("Please input movie name: ")
                        new_movie['genres'] = input("Please input movie genre: ")
                        new_movie['release_date'] = input("Please input date of release (dd/mm/yyyy): ")
                        
                        metadata = metadata.append(new_movie, ignore_index=True)
                        
                        print("The movie % has been successfully added" % new_movie['title'])
